    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen px-4">
            {educationData.map((edu, index) => (
                <div 
                    key={index} 
                    className="bg-gray-900 text-white p-6 rounded-2xl shadow-lg w-80 text-center mb-6 transition duration-300 transform hover:scale-105 hover:shadow-[0px_0px_30px_10px_rgba(255,255,255,1)]"
                >
